...
class Controller extends View {
    ...
    public function getUsers() {
        ...
        return UserIterator::loadByRole($this->configuration(), $this->id, $this->database, true);

    }

    public function getApplications() {

        return ApplicationIterator::loadByRole($this->configuration(), $this->id, $this->database, true);
