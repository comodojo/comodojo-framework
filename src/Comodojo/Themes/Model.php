...
class Model {
    ...
    public static function create(EnhancedDatabase $database, $name, $description, $package) {
    ...
    public static function update(EnhancedDatabase $database, $id, $name, $description, $package) {
